...
dezSettings.prototype.manageNavigationBarImg = function() {
	...
	switch(this.navigationBarImg) {
        case "images/sidebar-img/1.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/1.jpg");
			 break;
        case "images/sidebar-img/2.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/2.jpg");
            break;
		case "images/sidebar-img/3.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/3.jpg");
            break;
		case "images/sidebar-img/4.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/4.jpg");
            break;
		case "images/sidebar-img/5.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/5.jpg");
            break;
		case "images/sidebar-img/6.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/6.jpg");
            break;	
		case "images/sidebar-img/7.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/7.jpg");
            break;
		case "images/sidebar-img/8.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/8.jpg");
            break;
		case "images/sidebar-img/9.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/9.jpg");
            break;
		case "images/sidebar-img/10.jpg": 
            body.attr("data-navigationbarimg", "public/images/sidebar-img/10.jpg");
            break;
        default:
