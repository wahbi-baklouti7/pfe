...
<!-- Mirrored from eres.dexignzone.com/laravel/demo/uc-nestable by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 19:34:12 GMT -->
...
<head>
	...
	<meta name="csrf-token" content="ln5KIGIbgx1Ppl1aV8XdIfmIoBojAJuDV9Wo5Kl4">
	...
	<meta property="og:description" content="ERES Laravel | Nestable">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="email-inbox" class="dropdown-item ai-icon">
...
<a href="{{url('/staff')}}" class="dropdown-item ai-icon">
    <i class="fas fa-exchange-alt"></i>
    <span class="ms-2">Switch role</span>
</a>
...
<script src="assets/vendor/nestable2/js/jquery.nestable.min.js"  type="text/javascript"></script>
<script src="assets/js/plugins-init/nestable-init.js"  type="text/javascript"></script>
...
<!-- Mirrored from eres.dexignzone.com/laravel/demo/uc-nestable by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 19:34:14 GMT -->
</html>
