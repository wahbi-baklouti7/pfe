...
//Route::group([], function () {
  //  Route::resource('profil', ProfilController::class)->names('profil');
    //Route::get('register', [ProfilController::class, 'register'])->name('register');
   // Route::get('login', [ProfilController::class, 'login'])->name('login');
    //Route::get('forgot', [ProfilController::class, 'forgot'])->name('forgot');
//});
