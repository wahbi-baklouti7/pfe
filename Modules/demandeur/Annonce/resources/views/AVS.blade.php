                                                        ...
                                                        <div class="card-body">
                                                            <div class="text-center">
                                                                <div class="profile-photo">
                                                                    <img src="assets/images/maminou/icons/{{ $element->id }}.svg" width="80%" class=" img-fluid " alt="">
                                                                </div>
        ...
        button.addEventListener('click', function() {
            updateInputValue(button, 1); // Increment by 1
                                                ...
                                                <div class="profile-skills mb-5">
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-primary light btn-s mb-1">{{ $symptom->label }}</a>
                                                    @endforeach
...
.custom-card input[type="checkbox"]:checked + .card-body-wrapper .card-body {
    background-color: #d9fce5; /* Dark background color */
    color: white; /* Text and icon color */
    border-color: #d9fce5; /* Darker border color */
}

.custom-card input[type="checkbox"]:checked + .card-body-wrapper .card-footer {
    background-color: #d9fce5; /* Darker footer background */
    color: grey; /* Text color */
}
