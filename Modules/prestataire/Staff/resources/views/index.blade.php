                        ...
                        <div class="profile-tab">
                            <div class="custom-tab-1">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a href="#garde-enfants" data-bs-toggle="tab" class="nav-link">Garde D'enfants</a>
                                    </li>
                                    <li class="nav-item"><a href="#garde-avs" data-bs-toggle="tab" class="nav-link">Garde d'auxiliaire de vie</a>
                                    </li>
                                    <li class="nav-item"><a href="#garde-animal" data-bs-toggle="tab" class="nav-link">Garde animaux</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="garde-enfants" class="tab-pane fade">
                                    @include('staff::onglet.nounou')   
                                    </div>

                                    <div id="garde-avs" class="tab-pane fade">
                                    @include('staff::onglet.auxiliaire')   
                                    </div>

                                    <div id="garde-animal" class="tab-pane fade">
                                    @include('staff::onglet.animal')   
                                    </div>
